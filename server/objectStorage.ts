...
export class ObjectStorageService {
  ...
  async getLogoUploadURL(empresaId: string, extension: string = "png"): Promise<{ uploadURL: string, objectPath: string }> {
    const privateObjectDir = this.getPrivateObjectDir();
    const objectId = `${empresaId}_${Date.now()}.${extension}`;
    ...
    return { uploadURL, objectPath: `/objects/logos/${objectId}` };
  }

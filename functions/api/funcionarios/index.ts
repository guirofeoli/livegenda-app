...
export const onRequestPost: PagesFunction<Env> = async (context) => {
  ...
  try {
    ...
    const { empresa_id, nome, cargo, telefone, email, horario_trabalho } = body;
    ...
    const result = await sql`INSERT INTO funcionarios (empresa_id, nome, cargo, telefone, email, horario_trabalho, ativo) VALUES (${empresa_id}, ${nome}, ${cargo || null}, ${telefone || null}, ${email || null}, ${horario_trabalho || null}, true) RETURNING *`;

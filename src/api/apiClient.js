...
// Mock Entity class that uses API
class ApiEntity {
...
// Auth mock - uses localStorage for now (can be upgraded to real auth later)
const apiAuth = {
  isLoggedIn: async () => {
  ...
  login: async (email, password) => {
    // For now, simulate login by finding empresa by email
    try {
